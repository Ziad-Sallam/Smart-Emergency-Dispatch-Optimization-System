...
const BreadCrumbs = ({ parentPath, currentPath }) => {
  return (
    <div className="flex flex-wrap justify-center items-center space-x-2 text-sm text-gray-500 font-medium w-fit m-3">
